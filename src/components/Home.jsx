...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      className='relative bg-[#d0c3f1] pb-20 w-screen min-h-screen flex flex-col justify-center items-center text-center overflow-hidden'
    >
      {/* Floral Circles */}
      ...
      <div className='relative z-10 w-screen max-w-lg'>
        <h1 className='text-[white] text-3xl sm:text-5xl pb-2'>Product <span className='text-[#40e0d0]'>Designer</span> </h1>
        <h1 className='text-white text-3xl sm:text-5xl pt-2'> <span className='text-[#40e0d0]'>Building</span> Things</h1>
